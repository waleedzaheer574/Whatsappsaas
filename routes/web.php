...
Route::prefix('app')->middleware('auth')->name('dashboard.')->group(function () {
    ...
    Route::middleware('subscribed')->group(function () {
        ...
        Route::post('/team/{member}/role', [DashboardActionController::class, 'updateTeamMemberRole'])->name('team.role');
        Route::delete('/team/{member}', [DashboardActionController::class, 'deleteTeamMember'])->name('team.destroy');
        Route::post('/whatsapp-accounts', [DashboardActionController::class, 'whatsappAccount'])->name('whatsapp.store');
        Route::post('/whatsapp-accounts/{account}/update', [DashboardActionController::class, 'updateWhatsAppAccount'])->name('whatsapp.update');
        ...
        Route::post('/automations/{automation}/toggle', [DashboardActionController::class, 'toggleAutomation'])->name('automations.toggle');
        Route::delete('/automations/{automation}', [DashboardActionController::class, 'deleteAutomation'])->name('automations.destroy');
        Route::post('/broadcasts', [DashboardActionController::class, 'broadcast'])->name('broadcasts.store');
        Route::post('/broadcasts/{broadcast}/send', [DashboardActionController::class, 'sendBroadcast'])->name('broadcasts.send');
        Route::delete('/broadcasts/{broadcast}', [DashboardActionController::class, 'deleteBroadcast'])->name('broadcasts.destroy');
        Route::post('/training', [DashboardActionController::class, 'training'])->name('training.store');
        Route::post('/training/{source}/reindex', [DashboardActionController::class, 'reindexTraining'])->name('training.reindex');
        Route::delete('/training/{source}', [DashboardActionController::class, 'deleteTraining'])->name('training.destroy');
