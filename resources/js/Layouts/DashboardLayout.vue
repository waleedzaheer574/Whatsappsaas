      ...
      <header class="sticky top-0 z-40 px-3 py-3 backdrop-blur-2xl sm:px-5">
        <div class="flex min-w-0 items-center gap-3">
          ...
          <div class="ml-auto flex min-w-0 items-center gap-2">
            <ThemeToggle />
            <button class="relative grid size-11 shrink-0 place-items-center rounded-2xl border border-white/80 bg-white/85 shadow-sm dark:border-white/10 dark:bg-white/10">
              <Bell class="size-5" />
              <span class="absolute right-2 top-2 size-2.5 rounded-full bg-red-500 ring-2 ring-white" />
            </button>
...
const items = [
  ...
  { label: 'Inbox', short: 'Inbox', href: '/app/inbox', icon: Inbox, badge: '12' },
